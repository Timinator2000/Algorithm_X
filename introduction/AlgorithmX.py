#  An AlgorithmXSolver based on Knuth's Algorithm X and his Dancing Links (DLX):
#  (DLX Based AlgorithmXSolver Last Revised 04/06/2024)
#
...
#
#    https://www.cs.mcgill.ca/~aassaf9/python/algorithm_x.htmlimport numpy as np
#
...
#
# Below here is the only code specific to the Breaking Bifid puzzle.
#
#------------------------------------------------------------------------------------------------------DLX Based Algorithm X Solver Last Revised 04/06/2024)
#
#   https://en.wikipedia.org/wiki/Knuth%27s_Algorithm_X
#
