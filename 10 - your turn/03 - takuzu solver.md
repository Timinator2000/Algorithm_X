...
The first two bullet points are the guidance you need to logically fill in more cells of the grid before Algorithm X begins searching for a full soluion. There are a pretty good handful of techniques you can find to fill in unknown cells. You do not have to find them all to pass every test cases and validators, but if you feel the logic pulling at you like the Death Star's tracktor beam, it might be best not to resist.
