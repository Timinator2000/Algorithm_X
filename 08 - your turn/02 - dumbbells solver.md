...
The requirements are straightforward. Some locations on the floor are still marked and one end of dumbbell _must_ cover those locations. Every other location on the floor _may_ be covered, but if it is covered, it can only be covered one time since the puzzle states, “the dumbbells can touch but not cross each other.
